...
contract sFRUIT is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Sin", "sFRUIT", 9) ERC20Permit() {
    ...
    /**
        @notice increases sFRUIT\ supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sFRUIT
